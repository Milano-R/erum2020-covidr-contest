...
Attendance to the event is for free, and [**tickets are available**](https://www.eventbrite.it/e/covidr-erum-2020-pre-conference-event-tickets-104133026686) until **May 22nd**. Additional information on how to access the event will be provided to all ticket holders closer to the event.
...
Being original in the contest means being able to address different aspects of the pandemic. The CovidR contest is looking for such excellence and originality and we will also judge how R analytics can be an efficient and valid technical service to this effort and in such a context.
